 ...
 */
let SpotLight = new T.SpotLight("red");
SpotLight.angle = Math.PI/36;
SpotLight.position.set(0,50,0);

let SpotLight2 = new T.SpotLight("orange");
SpotLight2.angle = Math.PI/36;
SpotLight2.position.set(50,0,0);

let SpotLight3 = new T.SpotLight("yellow");
SpotLight3.angle = Math.PI/36;
SpotLight3.position.set(0,0,50);

let SpotLight4 = new T.SpotLight("green");
SpotLight4.angle = Math.PI/36;
SpotLight4.position.set(0,0,-50);

let SpotLight5 = new T.SpotLight("blue");
SpotLight5.angle = Math.PI/36;
SpotLight5.position.set(-50,0,0);
