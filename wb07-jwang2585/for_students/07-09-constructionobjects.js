...
export class GrDumpTruck extends GrObject {
   ...
   */
  constructor(params = {}) {
    let dumTruck = new T.Group();
    super(`DumpTruck-${dumpTruckObCtr++}`, dumTruck, [
      ["x", -4, 4, 0],
      ["z", -4, 4, 0],
      ["theta", 0, 360, 0],
      ["trunk", -5, 0, 0],
      ["front wheels", -15, 15, 0],
      ["pair back wheels", -15, 15, 0]
    ]);
    let floor = new T.Mesh(
      new T.BoxGeometry(50, 5, 20),
    ...
    let trunck = new T.Group();
    dumTruck.add(trunck);

    let cart_floor = new T.Mesh(
      new T.BoxGeometry(43, 2, 20),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.7,
        roughness: 0.2
    ...
    cart_floor.position.x = -18;
    cart_floor.position.y = 16
    trunck.add(cart_floor);

    let cart_right = new T.Mesh(
      new T.BoxGeometry(43, 10, 2),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.7,
        roughness: 0.2
    ...
    cart_right.position.set(-18, 20, 10);
    trunck.add(cart_right);

    let cart_left = new T.Mesh(
      new T.BoxGeometry(43, 10, 2),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.7,
    ...
    cart_left.position.set(-18, 20, -10);
    trunck.add(cart_left);
    
    let cart_front = new T.Mesh(
      new T.BoxGeometry(2, 10, 22),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.7,
        roughness: 0.2
    ...
    cart_front.position.set(4, 20, 0);
    trunck.add(cart_front);

    let wheel = new T.Mesh(
      new T.CylinderGeometry(5, 5, 3),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.7,
        roughness: 0.2
    ...
    wheel1.position.set(10, 7.5, 10)
    dumTruck.add(wheel1);

    let wheel2 = wheel.clone();
    wheel2.position.set(10, 7.5, -10)
    dumTruck.add(wheel2);

    let wheel3 = wheel.clone();
    wheel3.position.set(-15, 7.5, 10)
    dumTruck.add(wheel3);

    let wheel4 = wheel.clone();
    wheel4.position.set(-15, 7.5, -10)
    dumTruck.add(wheel4);

    let wheel5 = wheel.clone();
    wheel5.position.set(-30, 7.5, 10)
    dumTruck.add(wheel5);

    let wheel6 = wheel.clone();
    wheel6.position.set(-30, 7.5, -10)
    dumTruck.add(wheel6);

    this.whole_obj = dumTruck;
    this.cart = trunck;
    this.wheel1 = wheel1;
    this.wheel2 = wheel2;
    this.wheel3 = wheel3;
    ...
    let scale = params.size ? Number(params.size) : 0.1;
    dumTruck.scale.set(scale, scale, scale);
  }
  ...
  update(paramValues) {
    ...
    this.cart.translateY(-15);
    this.cart.rotation.z = -1*degreesToRadians(paramValues[3]);
    this.cart.translateY(15);
    this.wheel1.rotation.z = degreesToRadians(paramValues[4]);
    this.wheel2.rotation.z = degreesToRadians(paramValues[4]);
    this.wheel3.rotation.z = degreesToRadians(paramValues[5]);
    this.wheel4.rotation.z = degreesToRadians(paramValues[5]);
    this.wheel5.rotation.z = degreesToRadians(paramValues[5]);
    this.wheel6.rotation.z = degreesToRadians(paramValues[5]);
  }
}
...
export class GrForkLift extends GrObject {
  ...
  constructor(params = {}) {
    ...
    super(`ForkLift-${forkLiftObCtr++}`, whole_obj, [
      ["x", -4, 4, 0],
      ["z", -4, 4, 0],
      ["theta", 0, 360, 0],
      ["up&down", 10, 40, 25],
    ...
    // forklif bottom
    let bottom_body = new T.Mesh(
      new T.BoxGeometry(20, 10, 20),
      new T.MeshStandardMaterial({
        color: "yellow",
        metalness: 0.5,
        roughness: 0.7
    ...
    bottom_body.position.y = 10
    whole_obj.add(bottom_body);
    // forklift cell
    let driver_cell = new T.Mesh(
      new T.BoxGeometry(10, 10, 20),
      new T.MeshStandardMaterial({
        color: "yellow",
        metalness: 0.5,
        roughness: 0.7
    ...
    driver_cell.position.set(5, 20, 0);
    whole_obj.add(driver_cell);
    
    // fork connection part
    let fork_part = new T.Mesh(
      new T.BoxGeometry(2, 20, 2),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.6,
        roughness: 0.3
    ...
    fork_part.position.set(11,15,0)
    whole_obj.add(fork_part);
    
    // fork
    let fork = new T.Object3D();
    whole_obj.add(fork);

    let fork_center = new T.Mesh(
      new T.BoxGeometry(2, 2, 10),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.6,
        roughness: 0.3
    ...
    fork_center.position.set(12,25,0)
    fork.add(fork_center);

    let fork_left = new T.Mesh(
    ...
    fork_left.position.set(17,25,5)
    fork.add(fork_left);

    let fork_right = new T.Mesh(
      new T.BoxGeometry(10, 2, 2),
      new T.MeshStandardMaterial({
        color: "#888888",
        metalness: 0.6,
    ...
    fork_right.position.set(17,25,-5)
    fork.add(fork_right);
    ...
    let wheel1 = wheel.clone();
    wheel1.position.set(10, 7.5, 10)
    whole_obj.add(wheel1);
    let wheel2 = wheel.clone();
    wheel2.position.set(10, 7.5, -10)
    whole_obj.add(wheel2);
    let wheel3 = wheel.clone();
    wheel3.position.set(-10, 7.5, 10)
    whole_obj.add(wheel3);
    let wheel4 = wheel.clone();
    wheel4.position.set(-10, 7.5, -10)
    whole_obj.add(wheel4);

    this.whole_obj = whole_obj;
    this.fork_connect = fork_part;
    this.fork = fork;
    this.wheel3 = wheel3;
    this.wheel4 = wheel4;
    this.whole_obj.position.x = params.x ? Number(params.x) : 0;
    ...
    this.whole_obj.position.z = params.z ? Number(params.z) : 0;
    let scale = params.size ? Number(params.size) : 0.1;
    whole_obj.scale.set(scale, scale, scale);
  }
  ...
  update(paramValues) {
    ...
    this.whole_obj.position.z = paramValues[1];
    this.whole_obj.rotation.y = degreesToRadians(paramValues[2]);
    this.fork.position.y = paramValues[3]-25;
    if (paramValues[3] > 25) {
      this.fork_connect.position.y = paramValues[3]-10;
    }
    this.fork.children[1].translateX(-5);
    this.fork.children[1].rotation.z = degreesToRadians(paramValues[5]);
    this.fork.children[1].rotation.y = degreesToRadians(paramValues[4]);
    this.fork.children[1].translateX(5);
    this.fork.children[2].translateX(-5);
    this.fork.children[2].rotation.z = degreesToRadians(paramValues[5]);
    this.fork.children[2].rotation.y = -1*degreesToRadians(paramValues[4]);
    this.fork.children[2].translateX(5);
    this.wheel3.rotation.z = degreesToRadians(paramValues[6]);
    this.wheel4.rotation.z = degreesToRadians(paramValues[6]);
  }
}
